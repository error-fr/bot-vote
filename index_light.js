...
// Initialisation des IPs déjà utilisées au démarrage
global.recentIPs = loadRecentIPs();
    ...
    await page.waitForFunction(
        ...
        try {
            ...
            if (process.env.PROXY_SAFE_MODE && process.env.PROXY_SAFE_MODE === 'true') {
                ...
                // saveRecentIPs(); // Sauvegardé après la fin du script
            }
        } catch (err) {
...
// Sauvegarder avant la fermeture du processus
process.on('exit', () => {
    saveRecentIPs();
});
